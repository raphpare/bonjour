...
import { DAY_MS, SECOND_MS } from '../utils/milliseconds';
    ...
    set #events(events: B5rEvent[]) {
        ...
        while (index--) {
            ...
            if (
                ...
                newEventStart._dateRange = {
                    start: eventStart,
                    end: new Date(yearStart, monthStart, dateStart, 23, 59, 59),
                };

                // eslint-disable-next-line no-console
                console.log(
                    '==newEventStart._dateRange',
                    newEventStart._dateRange.end.getDate()
                );
                ...
                console.log(
                    'newEventEnd._dateRange',
                    newEventEnd._dateRange.end.getDate()
                );
                ...
                while (daysBetween > 0) {
                    ...
                    eventBetweenStartAndEnd._dateRange = {
                        start,
                        end: new Date(start.getTime() + DAY_MS - SECOND_MS),
                    };
